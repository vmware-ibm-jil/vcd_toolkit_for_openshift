...
WORKER3=172.16.0.27   # STATIC IP of worker VM
WORKER4=172.16.0.28   # STATIC IP of worker VM
WORKER5=172.16.0.29   # STATIC IP of worker VM
STORAGE0=172.16.0.30   # STATIC IP of worker VM
STORAGE1=172.16.0.31   # STATIC IP of worker VM
STORAGE2=172.16.0.32   # STATIC IP of worker VM
...
STORAGENAME=storage                  # prefix of storage VM names.  Must be "storage". fqdn will be, for example, worker-00.<PREFIXTODOMAIN>.<BASDDOMAIN>
...
LBTEMPLATE='LB4Openshift-0.1'                   # name of load balancer template
